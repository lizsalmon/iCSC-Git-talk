...
<!-- LEFT: Concepts -->
<div>
<h2 class="mb-4">Commits Are the Basis</h2>
...
<!-- Snapshot -->
<div v-click="1" v-click.hide="2" class="flex justify-around rounded-lg bg-blue-500/20 p-3">
```ts
// file-one.ts
```
```py
...
<div class="flex-1 rounded-lg bg-blue-500/20 p-3">
```ts
// file-one.ts
```
```py
...
<Arrow v-click="3" x1="670" y1="300" x2="800" y2="208" />
